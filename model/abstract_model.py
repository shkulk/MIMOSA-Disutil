...
def create_abstract_model(
    ...
    elif welfare_module == "inequal_aversion_elasmu_disutil":
        constraints.extend(welfare.inequal_aversion_elasmu_disutil.get_constraints(m))
    elif welfare_module == "inequal_aversion_elasmu_disutil_emdd":
        constraints.extend(welfare.inequal_aversion_elasmu_disutil_emdd.get_constraints(m))
    else:
